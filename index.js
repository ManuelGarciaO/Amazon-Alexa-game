...
const GAME_LENGTH = 5;
const SKILL_NAME = 'juego de fonética';
...
const languageString = {
  es: {
    translation: {
      ...
      ANSWER_CORRECT_MESSAGE: 'correcta,  eres muy inteligente. ,,',
      ANSWER_WRONG_MESSAGE: 'incorrecta, sigue intentando campeón ,,',
      CORRECT_ANSWER_MESSAGE: 'La respuesta correcta es %s: %s. ,',
      ANSWER_IS_MESSAGE: 'Esa respuesta es ,',
      TELL_QUESTION_MESSAGE: 'Pregunta %s. %s ,',
      GAME_OVER_MESSAGE: 'Has obtenido %s respuestas correctas de %s preguntas., sigue asi, ¡Gracias por jugar conmigo!',
